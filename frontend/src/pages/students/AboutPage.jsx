...
const AboutPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-[#E8FDFF] via-[#F0F9FF] to-[#E8FDFF] overflow-y-auto">
      ...
      {/* Contact CTA */}
      <div className="w-full px-6 lg:px-16 pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-[#FF993A] to-[#FF7A1A] rounded-3xl p-8 lg:p-12 text-center shadow-2xl">
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
              Ready to Transform Your Learning?
            </h2>
            <p className="text-white/90 text-lg mb-8">
              Join thousands of students already using Askaksha
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-[#FF993A] px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 inline-flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1">
                <i className="ri-rocket-line text-xl"></i>
                Get Started
              </button>
              <button className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white/10 transition-all duration-300 inline-flex items-center justify-center gap-2">
